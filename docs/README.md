...
- Django runs the public marketing website and its content-management screens.
- Jackrabbit owns registration, class availability and tuition, family accounts,
  payments, refunds, and business reporting.
...
- Uploaded website images and the Django database must be backed up together.
  Jackrabbit data must be protected, retained, and exported separately under
  the owner's approved procedures and Jackrabbit's available controls.
